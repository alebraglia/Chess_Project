...
public class Check {
    ...
    private boolean inRookPath(int col, int row, Piece king, int kingCol, int kingRow, int colVal, int rowVal) {
        ...
        for (int i = 1; i < 8; i++) {
            ...
            //Recupero del pezzo nella casella attuale
    ...
    private boolean inPawnPath(int col, int row, Piece king, int kingCol, int kingRow) {
        ...
        return checkPawn(board.getPiece(kingCol + 1, kingRow + team), king, col, row) || checkPawn(board.getPiece(kingCol - 1, kingRow + team), king, col, row);
